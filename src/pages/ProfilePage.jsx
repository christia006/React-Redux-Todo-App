...
import {asyncSetIsUserChangePhoto, 
setIsUserChangePhotoActionCreator} from
'../states/isUserChangePhoto/action';
function ProfilePage() {
const dispatch = useDispatch();
const {
authLogin,
isUserChangePhoto = false,
...
<UserDetail authLogin={authLogin}
onUserChangePhoto={onUserChangePhoto}></UserDetail>
</div> </section>
);
}
